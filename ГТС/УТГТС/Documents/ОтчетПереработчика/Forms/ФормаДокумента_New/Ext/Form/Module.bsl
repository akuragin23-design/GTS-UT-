...
Процедура ПодборТоваровИзЗаказа()
	...
	ОткрытьФорму("Документ.ОтчетПереработчика.Форма.ПодборПродукцииИзЗаказа_New", ПараметрыФормы,,,,, ОписаниеОповещения);
...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.ASP_УстановитьУсловноеОформлениеЕдиницИзмерения(
		ЭтаФорма,
...
#Область УслугиСуммаНДС_ТолькоПросмотр
	...
	ПравоеЗначение = УчетНДСУП.ASP_СписокНезначащихСтавок();
...
Процедура ПодобратьИзПоступлений(ИмяТабличнойЧасти)
	...
	ОткрытьФорму("Документ.ОтчетПереработчика.Форма.ПодборПродукцииИзПоступлений_New", ПараметрыФормы,,,,, ОписаниеОповещения);
