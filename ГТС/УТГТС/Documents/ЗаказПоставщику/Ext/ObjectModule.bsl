...
Процедура ЗаполнитьДокументПоОтбору(Знач ДанныеЗаполнения)
	...
	Если ДанныеЗаполнения.Свойство("Товары") Тогда
		//++ASP_Crow 11.03.2026 000029567 в расширение полностью
		//++ASP_Crow 26.04.2024 000021639 по просьюе Юрия очищаем упаковку
...
// Альтер ЛОГО+:	Заполняет заказ поставщику на основании заказа клиента
Процедура ЗаполнитьДокументНаОснованииЗаказаКлиента(Знач Основание)
	...
	//	Возврат;
	//КонецЕсли;	
	ЗаказКлиента = Основание.Основание;
