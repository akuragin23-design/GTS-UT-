...
Функция ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры = Неопределено) Экспорт
	...
	Если Не ДопПараметры.ПолучитьТекстыЗапроса Тогда
		...
		//++ASP_Crow 10.07.2024 000023822 Уйдем в типовую версию если товары в пути
		Если ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ЗакупкаПоИмпортуТоварыВПути Тогда
			ТекстЗапросаТаблицаТоварыОрганизаций_Типовой(Запрос, ТекстыЗапроса, Регистры, ДокументОбъект);
		Иначе	
...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры, ДокументОбъект = Неопределено) Экспорт
	//++ASP_Crow 10.03.2026 000029567 в расширение
	//++ASP_Crow 24.05.2024 000023121 отбор для себестоимости, чтоб движения были 
	МассивТоварыВПути = новый Массив();
	МассивТоварыВПути.Добавить(Перечисления.ХозяйственныеОперации.ЗакупкаПоИмпортуТоварыВПути);
	МассивТоварыВПути.Добавить(Перечисления.ХозяйственныеОперации.ЗакупкаПоИмпортуПоступлениеИзТоваровВПути);
...
Функция ТекстЗапросаТаблицаТоварыУслугиКОформлениюОтчетовКомитентуОЗакупках(Запрос, ТекстыЗапроса, Регистры, ДокументОбъект)
	...
	Возврат ТекстЗапроса;
КонецФункции
//++ASP_Crow 10.07.2024 000023822 Восстановлено из типовой УТ
Функция ТекстЗапросаТаблицаТоварыОрганизаций_Типовой(Запрос, ТекстыЗапроса, Регистры, ДокументОбъект = Неопределено) Экспорт
	//++ASP_Crow 10.03.2026 000029567 в расширени
