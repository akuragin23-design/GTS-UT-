...
Процедура УстановитьПредставлениеДокументаОснования()
	...
	Если ЗначениеЗаполнено(Объект.ДокументПриобретения) Тогда
		...
		ОписаниеДокументПриобретения = Новый ФорматированнаяСтрока(Строка(Объект.ДокументПриобретения),,ЦветаСтиля.ЦветГиперссылки,,"ОткрытьДокумент");
	...
	Если Объект.Проведен Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			ИначеЕсли КоличествоВыданы = 0 И КоличествоПеревыставить = 1 Тогда
				...
				МассивГиперСсылок.Добавить(Новый ФорматированнаяСтрока(ТекстКПеревыставлению, , ЦветаСтиля.ЦветГиперссылки,, ?(ДоступКСчетуФактуреВыданному, 
			...
			ИначеЕсли КоличествоВыданы = 1 И КоличествоПеревыставить = 0 Тогда
				...
				МассивГиперСсылок.Добавить(Новый ФорматированнаяСтрока(ТекстСчетФактура, , ЦветаСтиля.ЦветГиперссылки,, ?(ДоступКСчетуФактуреВыданному, 
			...
			ИначеЕсли КоличествоВыданы > 1 И КоличествоПеревыставить = 0 Тогда
				...
				МассивГиперСсылок.Добавить(Новый ФорматированнаяСтрока(ТекстВыданы, , ЦветаСтиля.ЦветГиперссылки,, ?(ДоступКСчетуФактуреВыданному, 
