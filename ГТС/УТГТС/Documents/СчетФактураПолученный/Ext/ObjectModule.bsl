...
Функция ПолучитьДанныеОснований(МассивДокументовОснований)
	...
	Для Каждого Основание Из МассивДокументовОснований Цикл
		...
		Если ТаблицыДляДвижений.Свойство("ТаблицаЗаполнениеШапкиСФПолученный") Тогда 
			ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицыДляДвижений.ТаблицаЗаполнениеШапкиСФПолученный, ДанныеОснований);  
		Иначе 
			Строка = ДанныеОснований.Добавить();
			Строка.Регистратор = Основание.Ссылка;
			Строка.Организация = Основание.Организация;
			Строка.Контрагент = Основание.Контрагент;
			Строка.Подразделение = Основание.Подразделение;
