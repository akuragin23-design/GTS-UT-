...
#Область Доработки
//ГТС доработка для загрузки из внешнего файла
&НаКлиенте
Процедура ЗагрузитьИзВнешнегоФайла(Команда) 
	...
	//	ПараметрыФормы.Вставить("ОтборПоТипуНоменклатуры", Новый ФиксированныйМассив(НоменклатураКлиентСервер.ОтборПоТоваруМногооборотнойТаре()));
	//КонецЕсли;
	//++ASP_Crow 25.03.2024 000021639 В 11.5 ЗагрузкаДанныхИзВнешнихФайлов заменилась на ЗагрузкаТоваровИзВнешнихФайлов 
	//ОткрытьФорму(
	//	"Обработка.ЗагрузкаТоваровИзВнешнихФайлов.Форма.Форма",
	//	ПараметрыФормы,
	//	ЭтаФорма,
	//	УникальныйИдентификатор);
    //--ASP_Crow 25.03.2024 000021639
КонецПроцедуры
