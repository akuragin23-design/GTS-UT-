...
Процедура ПриКопировании(ОбъектКопирования)
	...
	//ГТС изменение статуса ASP_Crow 11.03.2026 000029567 в расширение 
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено, ЗаполнятьВариантОбеспечения = Истина)
	...
	//ГТС изменение статус ASP_Crow 11.03.2026 000029567 в расширение 
	 Статус=Перечисления.СтатусыВнутреннихЗаказов.КВыполнению;
	//ГТС
...
Процедура ЗаполнитьПоЗаказуКлиента(ДанныеЗаполнения)
	...
	Подразделение           = Реквизиты.Подразделение;
	НаправлениеДеятельности = Реквизиты.НаправлениеДеятельности;
	Статус = Перечисления.СтатусыВнутреннихЗаказов.КВыполнению;//ASP_Dante 12/07/21 Задача 000011492 перенос доработок ASP_Crow 11.03.2026 000029567 в расширение 	
	СкладПолучатель = ДанныеЗаполнения.Склад;
