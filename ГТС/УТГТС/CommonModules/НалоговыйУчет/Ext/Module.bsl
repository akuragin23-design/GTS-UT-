...
//		|	ЕСТЬNULL(ПорядокОтраженияСчетовУчета.СчетСписанияОСНО, ДолиСписания.СтатьяРасходов.СчетСписанияОСНО) КАК СчетСписанияОСНО,
...
//		|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ПорядокОтраженияРасходов КАК ПорядокОтраженияСчетовУчета
//		|		ПО Остатки.Субконто1 = ПорядокОтраженияСчетовУчета.СтатьяРасходов
//		|		И Остатки.Организация = ПорядокОтраженияСчетовУчета.Организация
//		|		И Остатки.Подразделение = ПорядокОтраженияСчетовУчета.Подразделение
//		|
//		|";
//	
//	Выборка = Запрос.Выполнить().Выбрать();
...
//	
//	РегистрацияВНалоговомОргане = Справочники.Организации.РегистрацияВНалоговомОргане(Организация, Период);
//	
