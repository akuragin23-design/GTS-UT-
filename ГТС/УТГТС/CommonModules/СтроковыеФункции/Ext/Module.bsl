...
// Стилевые свойства:
//  - color - Определяет цвет текста. Например, color: ЦветГиперссылки;
...
// Стилевые свойства разделяются точкой с запятой. Например, style="color: ЦветГиперссылки; font: ОсновнойЭлементСписка"
