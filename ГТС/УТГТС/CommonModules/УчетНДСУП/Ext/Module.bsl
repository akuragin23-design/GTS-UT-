...
// 	     * ПодразделениеУчета - СправочникСсылка.СтруктураПредприятия - Подразделение, в котором учитываются приобретаемые товары, работы услуги, активы.
//
Процедура ASP_ОтразитьПриобретениеУПоставщика(Запрос, ТекстыЗапроса, Регистры, ТекстЦенности) Экспорт
...
#КонецОбласти
	...
	УчетНДСЛокализация.АСП_ОтразитьПриобретениеУПоставщика(Запрос, ТекстыЗапроса, Регистры, ТекстЦенности);
...
//
Функция ASP_СписокНезначащихСтавок() Экспорт
