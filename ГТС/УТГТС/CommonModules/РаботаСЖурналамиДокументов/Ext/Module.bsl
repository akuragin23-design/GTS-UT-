...
Процедура СоздатьНаФормеГруппуНастроекДинамическогоСписка(Форма, Параметры, СтруктураНастроек)
	...
	ДокументыОтборыИсправить.ЦветТекста = ЦветГиперссылки;
	...
	ДокументыПорядокИсправить.ЦветТекста = ЦветГиперссылки;
	...
	ДокументыУсловноеОформлениеИсправить.ЦветТекста = ЦветГиперссылки;
	...
	ГруппаОтсутствиеПроблем.ЦветТекстаЗаголовка = ЦветГиперссылки;
