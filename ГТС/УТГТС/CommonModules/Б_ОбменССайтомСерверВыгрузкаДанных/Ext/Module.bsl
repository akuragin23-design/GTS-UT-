...
Процедура ФормированиеПакетовДанных(ПараметрыОбмена, Операция) Экспорт
	...
	Если Операция = "ОбщаяИнформация" тогда
		...
		Для Каждого СтрокаТаблицыКаталогов Из ПараметрыОбмена.ТаблицаКаталогов Цикл
			...
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL = &П7", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL = &П8", "ИСТИНА = ИСТИНА");
			...
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В (&П7)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В (&П8)", "ИСТИНА = ИСТИНА");
			
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П)",  "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П1)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П2)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П3)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П4)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П5)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П6)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П7)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В (&П8)", "ИСТИНА = ИСТИНА");
			
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П)",  "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П1)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П2)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П3)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П4)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П5)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П6)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П7)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "NULL В ИЕРАРХИИ (&П8)", "ИСТИНА = ИСТИНА");
			
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П)",  "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П1)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П2)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П3)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П4)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П5)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П6)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П7)", "ИСТИНА = ИСТИНА");
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "НЕ NULL В ИЕРАРХИИ (&П8)", "ИСТИНА = ИСТИНА");
			...
			//++ASP_Kalyanin 000027474 10.07.25 
			ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "И СоглашенияСКлиентами.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыСоглашенийСКлиентами.Действует)",
...
Процедура УстановкаОтбораКомпоновщика(КомпоновщикНастроек, ПараметрыОбмена, СтрокаКаталога) 
	...
	Если мКлассифицироватьПоДеревуГрупп Тогда
		...
		Если мСписокГруппКаталога.Количество() > 0 Тогда  
			...
			Запрос = Новый Запрос;
			Запрос.УстановитьПараметр("ОтборПоВидамНоменклатуры", КлассифицироватьПоВидамНоменклатуры); 
			Запрос.УстановитьПараметр("СписокГруппКаталога"		, мСписокГруппКаталога);    
			...
			|ГДЕ
			|	(Номенклатура.Ссылка В ИЕРАРХИИ (&СписокГруппКаталога)
			|				И НЕ &ОтборПоВидамНоменклатуры
			|			ИЛИ Номенклатура.ВидНоменклатуры В (&СписокГруппКаталога)
			...
			|	И Б_ПользовательскиеГруппыТоваровТовары.Номенклатура <> ЗНАЧЕНИЕ(Справочник.Номенклатура.ПустаяСсылка)
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	Номенклатура.Ссылка КАК Номенклатура
			|ПОМЕСТИТЬ ВТ_ТоварыПГТ
			|ИЗ
			|	Справочник.Номенклатура КАК Номенклатура
			|ГДЕ
			|	Номенклатура.Ссылка В ИЕРАРХИИ
			|			(ВЫБРАТЬ
			|				ВТ_ГруппыТоварыПГТ.Номенклатура
			|			ИЗ
			|				ВТ_ГруппыТоварыПГТ)
			|
			|ИНДЕКСИРОВАТЬ ПО
			...
			|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_ТоварыПГТ КАК ВТ_ТоварыПГТ
			|		ПО ВТ_Товары.Номенклатура = ВТ_ТоварыПГТ.Номенклатура";
...
Функция ПолучитьКодМаркировки(ВидПродукцииИС)
...
Функция СформироватьВременныеТаблицыПоИнформацииОСкидкахПакета(ПараметрыОбмена, СписокСкидок, СписокВидовДисконтныхКарт, спкНоменклатуры, спкКонтрагентов, спкСоглашений)
	...
	|ГДЕ
	|	(СоглашенияСКлиентами.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыСоглашенийСКлиентами.Действует) ИЛИ СоглашенияСКлиентами.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыСоглашенийСКлиентами.НеСогласовано))
	...
	//++ASP_Kalyanin 000027474 10.07.25 
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "СоглашенияСКлиентами.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыСоглашенийСКлиентами.Действует)",
		...
		Если Б_ОбменССайтомСервер.ЭтоГруппаВерхнегоУровня(СтрокаДерева.Объект, СписокГрупп) Тогда
			...
			Если СтрокаДерева.Строки.Количество() > 0 Тогда
				...
				Если Б_ОбменССайтомСервер.НужноВыгружатьГруппу(СписокГрупп, СтрокаДерева.Объект) тогда
					...
					НаименованиеГруппы = Лев(СтрокаДерева.Объект.Наименование, 250);
					НаименованиеГруппы = ?(ЗначениеЗаполнено(НаименованиеГруппы), НаименованиеГруппы, "Без наименования");
					...
					XDTOГруппа.Наименование 	= НаименованиеГруппы;
...
Функция СформироватьВременныеТаблицыПоИнформацииОТоварахПакета(ПараметрыОбмена, ИдентификаторКаталога, СписокТоваров, СписокСвойств)
	...
	|	НЕ Склады.ЭтоГруппа
	|	И Склады.Ссылка В(&СписокСкладов)
	//ASP_Dante 05/09/21 + (илья при обновлении)
	...
	//ASP_Dante 05/09/21 РАЗРЕШЕННЫЕ
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	//ASP_Dante 05/09/21 разреш
	ЗапросОстатков= "ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	...
	|				ТОГДА ЦеныНоменклатурыСрезПоследних.Цена
	|			ИНАЧЕ 0
//ASP_Dante 05/09/21//гтс |		КОНЕЦ > 0	
	|		КОНЕЦ >= 0	
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
...
//	//ASP_Dante 09/09/19
	|	,НоменклатураПрисоединенныеФайлы.ФайлХранилище КАК ХранимыйФайл
//	//ASP_Dante 09/09/19
...
//ASP_Dante 05/09/21	
	...
	|	ВремНоменклатураСВсемиПрисоединеннымиФайлами.ХранимыйФайл
//ASP_Dante 05/09/21 -
...
Процедура ВыгрузитьТоварыXDTO(ПараметрыОбмена, ИмяКаталога, Владелец, ВладелецТип, МенеджерВременныхТаблиц, СтрокаТаблицыКаталогов, МассивКартинок, МассивФайлов)
	...
	Если ТзнТоваров.Количество() > 0 тогда	
		...
		Для каждого ТекТовар из ТзнТоваров Цикл
			...
			//ГТС пробуем увеличить длину описания товара
			//лДополнительноеОписаниеНоменклатуры = ?(СтрДлина(лОписаниеТовара) > 10000, Лев(лОписаниеТовара, 10000), лОписаниеТовара);
			лДополнительноеОписаниеНоменклатуры = ?(СтрДлина(лОписаниеТовара) > 50000, Лев(лОписаниеТовара, 50000), лОписаниеТовара);
			...
			Для каждого ТекСтр из ПараметрыОбмена.СоответствиеОсновныхРеквизитовНоменклатуры Цикл
				...
				Если лЗначение <> Неопределено тогда 
					//ГТС начало Суммируем Вес комплектаций
					Если ТекСтр.НаименованиеПоля = "Вес" и лЗначение = 0 ТОГДА
						...
						|	ЕстьNULL(ВариантыКомплектацииНоменклатурыТовары.Номенклатура.ВесЧислитель,0) КАК ВесЧислитель,
						|	ЕстьNULL(ВариантыКомплектацииНоменклатурыТовары.Номенклатура.ВесЗнаменатель,0) КАК ВесЗнаменатель
						|ИЗ
						|	Справочник.ВариантыКомплектацииНоменклатуры.Товары КАК ВариантыКомплектацииНоменклатурыТовары
						|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК Номенклатура1
						|		ПО ВариантыКомплектацииНоменклатурыТовары.Номенклатура = Номенклатура1.Ссылка
						|ГДЕ
						|	ВариантыКомплектацииНоменклатурыТовары.Ссылка.Владелец = &ТекТовар";
						
						Запрос.УстановитьПараметр("ТекТовар", ТекТовар.Номенклатура);
						...
						Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
							если ВыборкаДетальныеЗаписи.ВесЗнаменатель > 0 тогда
								Вес = Вес + ВыборкаДетальныеЗаписи.Количество*ВыборкаДетальныеЗаписи.ВесЧислитель/ВыборкаДетальныеЗаписи.ВесЗнаменатель;
							Иначе
								Вес = Вес + ВыборкаДетальныеЗаписи.Количество*ВыборкаДетальныеЗаписи.ВесЧислитель ;
							Конецесли;
						КонецЦикла;
						лЗначение =  окр(Вес,2);
			...
			Если ПараметрыОбмена.ВыгружатьКартинкиИФайлы и ПараметрыОбмена.ВыгрузкаФайловПереключатель = 0 тогда   //  000026679 добавлена проверка  ВыгрузкаФайловПереключатель
			...
			КонецЕсли;
			//ГТС начало набор = тип товар
			Если строка(ТекТовар.ТипНоменклатуры) = "Набор" тогда
				лТипНоменклатуры = "Товар";
			КонецЕсли;
			//ГТС конец
			...
			Для каждого ТекСтр из ПараметрыОбмена.СоответствиеДополнительныхРеквизитовНоменклатуры Цикл
				...
				Если лЗначение <> Неопределено тогда 
                    //гтс начало суммируем объем наборов
					Если ТекСтр.НаименованиеПоля="Объем" и строка(ТекТовар.ТипНоменклатуры) = "Набор" тогда
					Запрос = Новый Запрос;
						Запрос.Текст = 
						"ВЫБРАТЬ
						|	ВариантыКомплектацииНоменклатурыТовары.Номенклатура,
						|	ВариантыКомплектацииНоменклатурыТовары.Количество,
						|	ВариантыКомплектацииНоменклатурыТовары.Номенклатура.ОбъемЧислитель КАК ОбъемЧислитель,
						|	ВариантыКомплектацииНоменклатурыТовары.Номенклатура.ОбъемЗнаменатель КАК ОбъемЗнаменатель
						|ИЗ
						|	Справочник.ВариантыКомплектацииНоменклатуры.Товары КАК ВариантыКомплектацииНоменклатурыТовары
						|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК Номенклатура1
						|		ПО ВариантыКомплектацииНоменклатурыТовары.Номенклатура = Номенклатура1.Ссылка
						...
						Объем=0;
						Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
							если ВыборкаДетальныеЗаписи.ОбъемЗнаменатель > 0 ТОГДА 
							Объем = Объем + ВыборкаДетальныеЗаписи.Количество*ВыборкаДетальныеЗаписи.ОбъемЧислитель/ВыборкаДетальныеЗаписи.ОбъемЗнаменатель;
							ИНАЧЕ
							Объем = Объем + ВыборкаДетальныеЗаписи.Количество*ВыборкаДетальныеЗаписи.ОбъемЧислитель;
							конецесли;
						КонецЦикла;
						лЗначение =  окр(Объем,2,1);
...
Функция ПолучитьДатуПланирования(лМенеджерВременныхТаблиц, Номенклатура, Характеристика = НеОпределено)
	...
	Пока РезультатЗапроса.Следующий() Цикл
		ДатыПоступления = ДатыПоступления + Формат(РезультатЗапроса.ДатаПоступления, "ДФ=dd.MM.yyyy"); 	
	КонецЦикла;
...
Функция ПолучениеШтрихКодаНоменклатурыИХарактеристики(Номенклатура, МенеджерВременныхТаблиц, Характеристика = НеОпределено)
	...
	Если СтрДлина(ШтрихКод) > 40 Тогда
		ШтрихКод = "";
	КонецЕсли;
...
Процедура ВыгрузитьСвойстваНоменклатурыXDTO(ПараметрыОбмена, Владелец, ВладелецТип, ВыборкаНоменклатуры, МенеджерВременныхТаблиц);
	...
	Если НЕ Выборка.Пустой() тогда	
		...
		Пока ВыборкаСвойств.Следующий() Цикл
			...
			//ГТС начало ставим статус товара по своему алгоритму
			если строка(ВыборкаСвойств.ИдентификаторСвойства) = "Статус товара (Справочник ""Номенклатура"" (Общие))" 
			тогда
			//получаем остатки
			Остаток = 0;
			...
			"ВЫБРАТЬ
			|	СУММА(ЕСТЬNULL(ЗапасыИПотребностиОстатки.ВНаличииОстаток, 0)-ЕСТЬNULL(ЗапасыИПотребностиОстатки.РезервироватьНаСкладеОстаток,0)) КАК ВРезервеОстаток1,
			...
			ЗапросОстатков.УстановитьПараметр("Номенклатура", ВыборкаНоменклатуры.Номенклатура);
					
			ОстаткиРезервов = ЗапросОстатков.Выполнить().Выбрать();
			Пока ОстаткиРезервов.Следующий() Цикл
			Остаток = Остаток + ОстаткиРезервов.ВрезервеОстаток1;
		КонецЦикла;
		//			Если строка(ВыборкаНоменклатуры.Номенклатура.ТипНоменклатуры) = "Набор" тогда
			  Если Остаток = 0 тогда
				...
				Запрос.УстановитьПараметр("ТекТовар", ВыборкаНоменклатуры.Номенклатура);
				...
				Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
					...
					"ВЫБРАТЬ
					|	СУММА(ЕСТЬNULL(ЗапасыИПотребностиОстатки.ВНаличииОстаток - ЗапасыИПотребностиОстатки.РезервироватьНаСкладеОстаток, 0)) КАК ВРезервеОстаток,
					|	ЗапасыИПотребностиОстатки.Номенклатура КАК Номенклатура
					|ИЗ
					|	РегистрНакопления.ЗапасыИПотребности.Остатки(, Номенклатура = &Номенклатура) КАК ЗапасыИПотребностиОстатки
					|ГДЕ
					...
					Пока ТЗ_ОстаткиРезервов.Следующий() Цикл
						...
						КоличествоДоступ  = ТЗ_ОстаткиРезервов.ВрезервеОстаток/ВыборкаДетальныеЗаписи.Количество;
						Иначе 
						КоличествоДоступ  = ТЗ_ОстаткиРезервов.ВрезервеОстаток
						КонецЕсли;
				...
				Если Остаток > 0 
				Тогда СтатусТовара = "В наличии";
				Иначе СтатусТовара = "Срок поставки уточняйте у менеджера";
				КонецЕсли;
			
				Если ВыборкаСвойств.ИдентификаторЗначения <> Null
				тогда СтатусТовара = "Срок поставки 2-7 дней";
				КонецЕсли;
			   	XDTOЗначенияСвойства.Значение.Добавить(XMLСтрока(СтатусТовара));
				ИНАЧЕ
				XDTOЗначенияСвойства.Значение.Добавить(XMLСтрока(ВыборкаСвойств.ИдентификаторЗначения));
				КОнецесли;	
	...
	Если ФайлДляВыгрузки.НадоВыгружать тогда
		...
		Если ФайлВХранилище Тогда
			...
			Иначе
				...
				Если ТипЗнч(ФайлДляВыгрузки.ДвоичныеДанныеФайла) = Тип("ХранилищеЗначения") тогда
					ДвоичныеДанныеФайла = ФайлДляВыгрузки.ДвоичныеДанныеФайла.Получить();
				Иначе
...
//+++  ASP_Мочалина  000026179    выгрузка Файла PDF с документом заказ клиента и отгрузка

Функция ВыгрузитьФайлДокумента(ПараметрыОбмена, ИмяКаталога, Документ)
	
	Результат = НеОпределено;  
	Если Документ.ТипДокумента = "Заказ" Тогда
		ФайлДляВыгрузки = ASP_Добавленный.ASP_ФормированиеПДФСчетаЗаказа(Документ.Объект);  
	ИначеЕсли Документ.ТипДокумента = "Отгрузка"	Тогда
		//++ASP_Crow 18.05.2026 000029567 Выгрузщка пдф отгрузки не требуется
		//ФайлДляВыгрузки = ASP_Добавленный.ASP_ФормированиеПДФУПДОтгрузки(Документ.Объект); 
		Возврат "";	  
		//--ASP_Crow 18.05.2026 000029567
	КонецЕсли;
	ДвоичныеДанныеФайла = ФайлДляВыгрузки.ДвоичныеДанные; 
	//НомерПроб = СтрНайти(Документ.Номер, "-");
	НомерДок = Прав(Документ.Номер,СтрДлина(Документ.Номер)-СтрНайти(Документ.Номер, "-")) ;
	
	//ИмяФайлаКартинки = "Doc "+ Документ.Номер + " " +  Документ.Дата + "." + ФайлДляВыгрузки.Расширение;	
	ИмяФайлаКартинки = "Doc-"+ НомерДок + "-" + Формат(Документ.Дата, "ДФ=ддММгггг") + "." + ФайлДляВыгрузки.Расширение;	
	КаталогКартинки	 = Б_ОбщиеПроцедурыИФункцииСервер.ПолучитьПутьДляПлатформы(ПараметрыОбмена.ПлатформаWindows, (ИмяКаталога + "\" + ПараметрыОбмена.ПодкаталогФайлов + "\" + НомерДок+ "-" + Формат(Документ.Дата, "ДФ=ддММгггг")));
	...
	Попытка
		ДвоичныеДанныеФайла.Записать(ПолноеИмяФайлаКартинки);
	Исключение
		Б_ОбменССайтомСервер.СообщитьПодробно("Не удалось записать файл счета на диск. Объект: " + Документ, ПараметрыОбмена);
		Возврат Результат;
	КонецПопытки;	
	
	
	Результат = ПараметрыОбмена.ПодкаталогФайлов + "/" +  НомерДок + "-" + Формат(Документ.Дата, "ДФ=ддММгггг") + "/" + ИмяФайлаКартинки;
...
Процедура ВыгрузитьПрайсы(ПараметрыОбмена, Владелец, ВладелецТип, лМенеджерВременныхТаблиц)
	...
	//ГТС для выгрузки на сайт берем только одну цену, если ДляСайтаОТвUSD назначена и больше нуля. 17.11.202
	тзнЦенврем = тзнцен.Скопировать();     
	
	ПостроительЗапроса = Новый ПостроительЗапроса; 
    ПостроительЗапроса.ИсточникДанных = Новый ОписаниеИсточникаДанных(тзнЦенврем); 
    НовыйОтбор = ПостроительЗапроса.Отбор.Добавить("ВидЦены"); 
    НовыйОтбор.Использование = Истина; 
    НовыйОтбор.ВидСравнения = ВидСравнения.Равно;
    НовыйОтбор.Значение = Справочники.ВидыЦен.НайтиПоНаименованию("ДляСайтаОТвUSD");   
	НовыйОтбор = ПостроительЗапроса.Отбор.Добавить("Цена"); 
    НовыйОтбор.Использование = Истина; 
	...
	Для Каждого СтрВрем Из ТЗ2 Цикл
       	Отбор = Новый Структура;
    	Отбор.Вставить("Номенклатура", СтрВрем.Номенклатура); 
		СтрокиНоменклатуры = тзнЦенврем.НайтиСтроки(Отбор);
		Для Каждого СтрокаНоменклатуры Из СтрокиНоменклатуры Цикл 
			Если СтрокаНоменклатуры.ВидЦены<>Справочники.ВидыЦен.НайтиПоНаименованию("ДляСайтаОТвUSD") Тогда 
	...
	//Запрос1.МенеджерВременныхТаблиц = лМенеджерВременныхТаблиц;
	//   Запрос1.Текст = "Выбрать * ИЗ ВремЦеныПоСоглашениям КАК ВремЦеныПоСоглашениям";
	//  ТЗТест = Запрос1.Выполнить().Выгрузить();
	...
	Если ТзнЦен.Количество() > 0 тогда
		...
		Для НомерСтроки = 0 по  КоличествоСтрок Цикл
			...
			//гтс начало корректируем тип цен
			//XDTOЦена.Валюта       		= Лев(ТекЦена.ВалютаЦены, 3);
			Если ЗначениеЗаполнено(ТекЦена.ВалютаЦены) тогда
				XDTOЦена.Валюта       		= Лев(ТекЦена.ВалютаЦены, 3);
			Иначе 			
				XDTOЦена.Валюта       		= Лев(ТекЦена.ВалютаСоглашения, 3);
			КонецЕсли;
			...
			Если ТекЦена.Цена > 0 тогда
				...
				//гтс  начало суммируем цены наборов
			иначеесли ТипЗнч(ТекЦена.ИдентификаторНоменклатуры) <> Тип("Строка") и ТекЦена.ИдентификаторНоменклатуры.ТипНоменклатуры = Перечисления.Типыноменклатуры.Набор И XDTOЦена.Валюта = "руб"
				Тогда
				...
				Запрос.УстановитьПараметр("ТекДата", ТекущаяДатаСеанса());
				Запрос.УстановитьПараметр("Владелец", ТекЦена.ИдентификаторНоменклатуры);
				Запрос.УстановитьПараметр("ВидЦены", ТекЦена.ИдентификаторСоглашения.ВидЦен);
				//стоп
				...
				ТЗ1Тест = РезультатЗапроса.Выгрузить();
				
				Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
					
					//Если АльтерЛого.РасчитатьЦенуПоКомплекту(ВыборкаДетальныеЗаписи.Номенклатура) тогда
					//		Цена = 0;
					//		Коэффициент = КоэффициентНаценки(ВыборкаДетальныеЗаписи.Номенклатура);
					//		Цена = АльтерЛого.ЦенаНоменклатурыПоКомплекту(ВыборкаДетальныеЗаписи.Номенклатура, ТекущаяДата(), ТекЦена.ИдентификаторСоглашения.ВидЦен, Цена, Коэффициент);
					//		Ценанабора = ценанабора + Цена * ВыборкаДетальныеЗаписи.Количество; 	
					//ИНАЧЕ
							Ценанабора = ценанабора + ВыборкаДетальныеЗаписи.Цена * ВыборкаДетальныеЗаписи.Количество;		
					//КонецЕсли;
				...
				XDTOЦена.ЦенаЗаЕдиницу 		= Формат(ЦенаНабора, ПараметрыОбмена.ФорматСуммы);
				ПредставлениеЦены 	= СокрЛП(ЦенаНабора) + " " + СокрЛП(ТекЦена.ВалютаСоглашения) + " за " + СокрЛП(Единица);
				XDTOЦена.Представление 		= ПредставлениеЦены;
				Если ЦенаНабора > 0 тогда  
				XDTOЦены.Цена.Добавить(XDTOЦена);
				КонецЕсли;
				иначеесли (ТекЦена.Цена = 0 И ТипЗнч(ТекЦена.ИдентификаторНоменклатуры) <> Тип("Строка") и ТекЦена.ИдентификаторНоменклатуры.ТипНоменклатуры <> Перечисления.ТипыНоменклатуры.Набор )
				ИЛИ (ТекЦена.Цена = 0 И ЦенаНабора = 0 ) Тогда
				 XDTOЦены.Цена.Добавить(XDTOЦена);
	...
	Пока Выборка.Следующий() Цикл
		...
		Если лВыгрузкаПоСкладам тогда
			...
			Для Каждого ТекСклад Из ТзнСкладов Цикл 
				...
				Запрос.УстановитьПараметр("ТекТовар", Выборка.ИдентификаторНоменклатуры);
				Запрос.УстановитьПараметр("Основной", ИСТИНА);
				Если "ТС-162 стеллаж (1000х1000х600) П"=Строка(Выборка.ИдентификаторНоменклатуры)
				Тогда
				Стоп=1;
				КонецЕсли;
				РезультатЗапроса = Запрос.Выполнить();
				...
				//ГТС Принудительное наличие на складе принудительного наличия при установленной галочке принудительно наличие в остатке
				Если Остаток = 0 И Строка(ТекСклад.Склад) = "Склад принудительного наличия" Тогда
				...
				|	И НоменклатураДополнительныеРеквизиты.Ссылка.Ссылка = &ТекТовар";
	
				Запрос1.УстановитьПараметр("Значение", ИСТИНА);
				Запрос1.УстановитьПараметр("Свойство", ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Принудительное наличие в остатке (Справочник ""Номенклатура"" (Общие))"));
				Запрос1.УстановитьПараметр("ТекТовар", Выборка.ИдентификаторНоменклатуры);
			    ...
			    //Принудительное наличие на складе Подольск при установленной галочке принудительно наличие в остатке на основном складе 17.11.2022
			
				Если Остаток = 0 И Строка(ТекСклад.Склад) = "Склад Подольск" Тогда
				...
				Запрос1.УстановитьПараметр("Значение", ИСТИНА);
				Запрос1.УстановитьПараметр("Свойство", ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию("Принудительное наличие в остатке на основном складе"));
				Запрос1.УстановитьПараметр("ТекТовар", Выборка.ИдентификаторНоменклатуры);
		...
		Иначе
			...
			//ГТС начало получаем возможные остатки наборов 
				...
				Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
					...
					"ВЫБРАТЬ
					|	СУММА(ЕСТЬNULL(ЗапасыИПотребностиОстатки.ВНаличииОстаток + ЗапасыИПотребностиОстатки.РезервироватьНаСкладеОстаток + ЗапасыИПотребностиОстатки.РезервироватьПоМереПоступленияОстаток, 0)) КАК ВРезервеОстаток,
					|	ЗапасыИПотребностиОстатки.Номенклатура КАК Номенклатура
					|ИЗ
					|	РегистрНакопления.ЗапасыИПотребности.Остатки(, Номенклатура = &Номенклатура) КАК ЗапасыИПотребностиОстатки
					|ГДЕ
			...
			Иначе
				...
				//гтс начало
				если Остаток > 0 Тогда
				XDTOОстаток.Количество 	= Остаток;
				конецесли;
...
//Добавляем для балок из документа заказа клиента
&НаСервере
...
Функция СформироватьВременныеТаблицыПоДокументам(ПараметрыОбмена, МассивДанных)
	...
	ЗапросПоЗаказам = "ВЫБРАТЬ
	                  ...
	                  |			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.УдалитьЗаказыКлиентов КАК Оформлено
	...
	|	ВремТабТоваровПром.НоменклатураНабора КАК НоменклатураНабора,
	|	ВремТабТоваровПром.ХарактеристикаНабора КАК ХарактеристикаНабора,
	|	ВремТабТоваровПром.ВариантОбеспечения КАК ВариантОбеспечения, 
	...
	ОбщийЗапрос.Выполнить();	
	//000026679 ASP_Мочалина добавлены позиции набора номенклатуры и варианта обеспечения к заказу 
...
Процедура ВыгрузитьДокументы(ПараметрыОбмена, ТаблицаДокументов)
	...
	//++000026679 ASP_Мочалина ЛКД, таблица получения данных для выгрузки на сайт
	Если  ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php" Тогда	
		ТаблКаталогов = Неопределено;
		ПараметрыОбмена.Свойство("ТаблицаКаталогов", ТаблКаталогов);
		Если ТаблКаталогов = Неопределено Тогда 
			ПараметрыОбмена.Вставить("ТаблицаКаталоговДоп", ПараметрыОбмена.СохраненнаяТаблицаКаталогов.Получить());
		КонецЕсли;
	КонецЕсли;
	//--000026679 
			...
			Для каждого ТекДокумент из НайденныеДокументы Цикл
				...
				Если ТекДокумент.ТипОбъекта = "Заказ" тогда
					...
					Для каждого ТекЗаказ из МассивЗаказов Цикл 
						...
						XDTOДокумент = ВыгрузитьЗаказXDTO(ПараметрыОбмена, лМенеджерВременныхТаблиц, ТекЗаказ, КоличествоЗаказов,Пакет); // 000026488  добавлен параметр пакет
					...
					Если ПараметрыОбмена.ВыгрузкаОтгрузок тогда
						...
						Для каждого ТекОтгрузка из МассивОтгрузок Цикл 
							...
							XDTOДокумент = ВыгрузитьОтгрузкуXDTO(ПараметрыОбмена, лМенеджерВременныхТаблиц, ТекОтгрузка, КоличествоОтгрузок,Пакет ); // 000026488  добавлен параметр пакет
	...
	// ASP_Мочалина 000026488  принудительная постановка на регистрацию для выгрузки на сайт ЛКД документа заказ клиента после его проведения в рамках текущего обмена 
	СписокДляОбмена = Новый Массив;
	Если ПараметрыОбмена.Свойство("ПоставитьНаРегистрациюПослеОбмена", СписокДляОбмена) и ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php" Тогда	
		Для каждого Док из  СписокДляОбмена Цикл 
			Если Док.Проведен Тогда         
				узел_ЛК = ПланыОбмена.Б_ОбменССайтом.НайтиПоКоду("000000004");
				ПланыОбмена.ЗарегистрироватьИзменения(узел_ЛК, Док);
			КонецЕсли;
		КонецЦикла;	
	КонецЕсли;	
	//000026488 
...
// Возвращаемое значение:
//   XDTO документ 
Функция ВыгрузитьЗаказXDTO(ПараметрыОбмена, МенеджерВременныхТаблиц, Документ, КоличествоЗаказов,Пакет)
	...
	XDTOДокумент.Номер1С 		= ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Документ.Номер, Истина, Истина);//ASP_ТрунькинБ 000027398
	...
	//++ASP_Kalyanin 000027219 09.06.25
		//лДатаВремяЭлДокумента  	= ?(ЗначениеЗаполнено(Документ.ДатаССайта), Документ.ДатаССайта, Дата(1,1,1,0,0,1));
		лДатаВремяЭлДокумента  		= ?(ЗначениеЗаполнено(Документ.ДатаССайта), Документ.ДатаССайта, Документ.Дата);
	//--ASP_Kalyanin 000027219 09.06.25
	...
	КонецЕсли;
		...
		//+++  ASP_Мочалина  000026179 выгрузка Файла PDF с документом заказ клиента
		Если Документ.Проведен  и ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php" Тогда   
			ИмяКаталога = Б_ОбщиеПроцедурыИФункцииСервер.ПолучитьПутьДляПлатформы(ПараметрыОбмена.ПлатформаWindows,  ПараметрыОбмена.КаталогНаДиске + "\documents\"+ Строка(Пакет));
			
			ФайлPDF = ВыгрузитьФайлДокумента(ПараметрыОбмена, ИмяКаталога, Документ);
			
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "счет", ФайлPDF);	 
			
			// ASP_Мочалина 000026488  Добавление реквизита Причина отмены  
			Причина = ""; 
			СписокПричинОтмены =  Документ.Заказ.Товары.Выгрузить(,"ПричинаОтмены");
			СписокПричинОтмены.Свернуть("ПричинаОтмены"); 
			Запись = РегистрыСведений.СостоянияЗаказовКлиентов.СоздатьМенеджерЗаписи();
			Запись.Заказ = Документ.Заказ;
			Запись.Прочитать();

			Если  Запись.Состояние = Перечисления.СостоянияЗаказовКлиентов.Закрыт и Запись.ПроцентОтгрузки = 0 и  Запись.ПроцентОплаты = 0 и СписокПричинОтмены.Количество()< 2 Тогда 
				СписокПричинОтмены =  Документ.Заказ.Товары.Выгрузить(,"ПричинаОтмены");
				СписокПричинОтмены.Свернуть("ПричинаОтмены");
				Причина = ?(ЗначениеЗаполнено(СписокПричинОтмены[0].ПричинаОтмены),СписокПричинОтмены[0].ПричинаОтмены.Наименование, "");  
			Иначе
				Для каждого Прич из СписокПричинОтмены Цикл
					Причина = Прич.ПричинаОтмены.Наименование + ", "+ Причина;
				КонецЦикла;	
			КонецЕсли;
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "Причина проигрыша", Причина);	 
	...
	Если ЕстьТовары тогда
		...
		XDTOТовары		= ПараметрыОбмена.МояФабрикаXDTO.Создать(XDTOТоварыТип);
		Если ЕстьТовары тогда  
		//++000026679	ASP_Мочалина группировка табличной части товаров перед выгрузкой на сайт
		Если  ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php"  Тогда
			КопияМассивТоваров = МассивТоваров.Скопировать();     
			Колонки = "Документ, Заказ, НоменклатураНабора,ХарактеристикаНабора, Номенклатура, ИдентификаторНоменклатуры, Характеристика, ИдентификаторХарактеристики, "+
			"Упаковка, ИдентификаторУпаковки, Цена, СтавкаНДС, ПроцентРучнойСкидки, ПроцентАвтоматическойСкидки, Содержание, УпаковкаЧислитель, НоменклатураЕдиницаИзмерения, Отменено, "+
			"НоменклатураНаименование, ХарактеристикаНаименование, ВидНоменклатуры, ТипТовара, НоменклатураСтавкаНДС, ИдентификаторБазовойЕдиницыИзмерения, НаименованиеБазовойЕдиницыИзмерения, "+
			"НаименованиеПолноеБазовойЕдиницыИзмерения, КодБазовойЕдиницыИзмерения, ОсобенностьУчета";
			МассивТоваров.Свернуть(Колонки,"КоличествоУпаковок,Количество,Сумма,СуммаНДС,СуммаСНДС,СуммаРучнойСкидки,СуммаАвтоматическойСкидки");  
			ЗаполнениеТабличнойЧастиДокумента(ПараметрыОбмена, МенеджерВременныхТаблиц, XDTOТовары, XDTOТоварыТип, Документ, МассивТоваров, ,КопияМассивТоваров);     			
		Иначе
...
// Возвращаемое значение:
//   XDTO документ 
Функция ВыгрузитьОтгрузкуXDTO(ПараметрыОбмена, МенеджерВременныхТаблиц, Документ, КоличествоОтгрузок, Пакет)
	XDTOДокументТип		= Б_ОбменССайтомСервер.ПолучениеТипОбъектаXDTO(ПараметрыОбмена,  "Документ");
	XDTOНалогиТип 		= Б_ОбменССайтомСервер.ПолучениеТипОбъектаXDTO(ПараметрыОбмена,  "Налоги"		, Истина, XDTOДокументТип);	
	XDTOНалогТип   		= Б_ОбменССайтомСервер.ПолучениеТипОбъектаXDTO(ПараметрыОбмена,  "Налог"		, Истина, XDTOНалогиТип);
	...
	XDTOЗначенияРеквизитов 		= ПараметрыОбмена.МояФабрикаXDTO.Создать(XDTOЗначенияРеквизитовТип); 
		...
		//+++  ASP_Мочалина  000026488 выгрузка УПД для отгрузок
		Отбор = Новый Структура();
		Отбор.Вставить("Организация", Документ.Объект.Организация);
		Отбор.Вставить("Перевыставленный", Ложь);
		ТаблицаСчетаФактуры = Документы.СчетФактураВыданный.СчетаФактурыПоОснованию(Документ.Объект, Отбор,  Неопределено, Ложь);
		ТаблицаСчетаФактуры.Свернуть("Номер,Дата,Проведен,Ссылка");

        ЕстьСчФ = ?(ТаблицаСчетаФактуры.Количество()>0, Истина, ЛОжь);
		
		Если Документ.Проведен и ЕстьСчФ и ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php"	Тогда  
			ИмяКаталога = Б_ОбщиеПроцедурыИФункцииСервер.ПолучитьПутьДляПлатформы(ПараметрыОбмена.ПлатформаWindows,  ПараметрыОбмена.КаталогНаДиске + "\documents\"+ Строка(Пакет));
			
			ФайлPDF = ВыгрузитьФайлДокумента(ПараметрыОбмена, ИмяКаталога, Документ);
			
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "УПД", ФайлPDF);	
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "Номер отгрузки по 1С", ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(ТаблицаСчетаФактуры[0].Номер, Истина, Истина));//ASP_ТрунькинБ 000027398	
		КонецЕсли ;	
		//---000026488
...
Функция ВыгрузитьОплатуXDTO(ПараметрыОбмена, МенеджерВременныхТаблиц, Документ, КоличествоОплат)
	...
	Если Документ.ТипДокумента  = "Оплата безналичными" тогда
		...
		//++APS_ТрунькинБ 000027398 02/07/25
		XDTOДокумент.Номер1С 		= ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Документ.Номер, Истина, Истина);
		//--APS_ТрунькинБ 000027398 02/07/25
...
Процедура ЗаполнениеТабличнойЧастиДокумента(ПараметрыОбмена, МенеджерВременныхТаблиц, Владелец, ВладелецТип, Документ, МассивНоменклатуры, СоздаватьДоставкуАвтоматически = Истина, КопияМассивТоваров = Неопределено)
	...
	//++ASP 000028159 Колчаев 01.10.2025 таблица значений в которую записывается текущая номенклатура по характеристике и цене
	//++ASP_СмирновН 16.11.25 000028672 не забываем про "номенклатуру набора", если мы проверяем на дубли. номенклатура может быть одинаковой, но в разных наборах
	ТаблицаПроверка = МассивНоменклатуры.СкопироватьКолонки("Номенклатура,НоменклатураНабора,Характеристика,Цена");
	//--ASP_СмирновН 16.11.25 000028672 
	ТаблицаПроверка.Очистить();
	//++ASP 000028159 Колчаев 01.10.2025 таблица значений в которую записывается текущая номенклатура по характеристике и цене
	Для каждого ТекНоменклатура из МассивНоменклатуры Цикл  
		
		//++000026679 ASP_Мочалина группировка табличной части товаров перед выгрузкой на сайт	
		Если не КопияМассивТоваров = Неопределено  Тогда 
			//++ASP 000028159 Колчаев 01.10.2025 убран отбор по сумме
			
			//Колонки = "Документ, Заказ, НоменклатураНабора, ХарактеристикаНабора, Номенклатура, ИдентификаторНоменклатуры, Характеристика, ИдентификаторХарактеристики, "+
			//"Упаковка, ИдентификаторУпаковки, Цена, СтавкаНДС, Содержание, УпаковкаЧислитель, НоменклатураЕдиницаИзмерения, Отменено, "+
			//"НоменклатураНаименование, ХарактеристикаНаименование, ВидНоменклатуры, ТипТовара, НоменклатураСтавкаНДС, ИдентификаторБазовойЕдиницыИзмерения, НаименованиеБазовойЕдиницыИзмерения, "+
			//"НаименованиеПолноеБазовойЕдиницыИзмерения, КодБазовойЕдиницыИзмерения, ОсобенностьУчета, Сумма";
			...
			//Отбор = Новый Структура(Колонки,ТекНоменклатура.Документ,ТекНоменклатура.Заказ,ТекНоменклатура.НоменклатураНабора,ТекНоменклатура.ХарактеристикаНабора,ТекНоменклатура.Номенклатура,ТекНоменклатура.ИдентификаторНоменклатуры,ТекНоменклатура.Характеристика,ТекНоменклатура.ИдентификаторХарактеристики,
			//ТекНоменклатура.Упаковка,ТекНоменклатура.ИдентификаторУпаковки,ТекНоменклатура.Цена,ТекНоменклатура.СтавкаНДС,ТекНоменклатура.Содержание,ТекНоменклатура.УпаковкаЧислитель,
			//ТекНоменклатура.НоменклатураЕдиницаИзмерения,ТекНоменклатура.Отменено,ТекНоменклатура.НоменклатураНаименование,ТекНоменклатура.ХарактеристикаНаименование,ТекНоменклатура.ВидНоменклатуры,ТекНоменклатура.ТипТовара,ТекНоменклатура.НоменклатураСтавкаНДС,
			//ТекНоменклатура.ИдентификаторБазовойЕдиницыИзмерения,ТекНоменклатура.НаименованиеБазовойЕдиницыИзмерения,ТекНоменклатура.НаименованиеПолноеБазовойЕдиницыИзмерения,ТекНоменклатура.КодБазовойЕдиницыИзмерения,ТекНоменклатура.ОсобенностьУчета,ТекНоменклатура.Сумма );
			
			Отбор = Новый Структура(
			Колонки,ТекНоменклатура.Документ,
			ТекНоменклатура.Заказ,ТекНоменклатура.НоменклатураНабора,
			ТекНоменклатура.ХарактеристикаНабора,ТекНоменклатура.Номенклатура,
			ТекНоменклатура.ИдентификаторНоменклатуры,ТекНоменклатура.Характеристика,
			ТекНоменклатура.ИдентификаторХарактеристики,ТекНоменклатура.Упаковка,
			ТекНоменклатура.ИдентификаторУпаковки,ТекНоменклатура.Цена,
			ТекНоменклатура.СтавкаНДС,ТекНоменклатура.Содержание,
			ТекНоменклатура.УпаковкаЧислитель,ТекНоменклатура.НоменклатураЕдиницаИзмерения,
			ТекНоменклатура.Отменено,ТекНоменклатура.НоменклатураНаименование,
			ТекНоменклатура.ХарактеристикаНаименование,ТекНоменклатура.ВидНоменклатуры,
			ТекНоменклатура.ТипТовара,ТекНоменклатура.НоменклатураСтавкаНДС,
			ТекНоменклатура.ИдентификаторБазовойЕдиницыИзмерения,ТекНоменклатура.НаименованиеБазовойЕдиницыИзмерения,
			ТекНоменклатура.НаименованиеПолноеБазовойЕдиницыИзмерения,ТекНоменклатура.КодБазовойЕдиницыИзмерения,
			ТекНоменклатура.ОсобенностьУчета);
			//--ASP 000028159 Колчаев 01.10.2025 убран отбор по сумме
			
			Строки = КопияМассивТоваров.НайтиСтроки(Отбор); 
			...
			КолНеОбеспечивать = 0;
			КолКОбеспечению = 0; 
			КолРезервироватьПоМереПоступления = 0; 
			КолОтгрузить = 0;
			КолПереданРанее = 0;
			
			//++ASP 000028159 Колчаев 01.10.2025 в этот массив складывается текущая номенклатура дальше
			МассивПроверка = Новый Массив;
			//++ASP_Трунькин 000029473 06/02/2026 масштабируем функционал
			МассивПроверкаКОбеспечению	 		= Новый Массив;
			МассивПроверкаОтгрузить		 		= Новый Массив;
			МассивПроверкаКолНеОбеспечивать 	= Новый Массив;
			МассивКолОтгрузить   				= Новый Массив;
			//--ASP_Трунькин 000029473 06/02/2026
			//--ASP 000028159 Колчаев 01.10.2025 в этот массив складывается текущая номенклатура дальше
			
			//++ASP 000028159 Колчаев 01.10.2025 ищем номенклатуру в проверочном массиве, если мы найдем повтор, то пропускаем эту итерацию для исключения дублей, иначе записываем текущую
			СуммаТекНоменклатура = 0;
			КоличествоТекНоменклатура = 0;
			//++ASP_СмирновН 16.11.25 000028672
			ОтборНайденнойТаблицы = Новый Структура("Номенклатура,НоменклатураНабора,Характеристика,Цена", Строки[0].Номенклатура, Строки[0].НоменклатураНабора, Строки[0].Характеристика, Строки[0].Цена);
			//--ASP_СмирновН 16.11.25 000028672
			НайденнаяСтрокаТаблицы = ТаблицаПроверка.НайтиСтроки(ОтборНайденнойТаблицы);
			Если ЗначениеЗаполнено(НайденнаяСтрокаТаблицы) Тогда
				Продолжить;
			Иначе
				СтрокаТаблицы = ТаблицаПроверка.Добавить();
				СтрокаТаблицы.Номенклатура = Строки[0].Номенклатура;
				СтрокаТаблицы.Характеристика = Строки[0].Характеристика;
				СтрокаТаблицы.Цена = Строки[0].Цена;
			КонецЕсли;
			//--ASP 000028159 Колчаев 01.10.2025 ищем номенклатуру в проверочном массиве, если мы найдем повтор, то пропускаем эту итерацию для исключения дублей
			
			Для каждого Стр из Строки Цикл 
				//++ASP 000028159 Колчаев 01.10.2025 сохранение общего количества и суммы по всем номенклатурам в "строки"
				КоличествоТекНоменклатура = КоличествоТекНоменклатура+Стр.Количество;
				СуммаТекНоменклатура = СуммаТекНоменклатура+Стр.Сумма;
				//--ASP 000028159 Колчаев 01.10.2025 сохранение общего количества и суммы по всем номенклатурам в "строки"
				Если Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.СоСклада  Тогда
					Если Стр.Склад = ОснСклад Тогда 
						КолОснСклад = КолОснСклад + Стр.Количество;
					Иначе
						//++ASP 000028159 Колчаев 01.10.2025 по каждому складу указывается отдельное число
						//КолДрСклады = КолДрСклады+ Стр.Количество;
						КолДрСклады = Стр.Количество;
						//--ASP 000028159 Колчаев 01.10.2025 по каждому складу указывается отдельное число
						//++ASP 000028159 Колчаев 01.10.2025 в комментарий записывается либо наименование склада для сайта, если оно заполнено и используется, либо стандартная наименование
						
						НаименованиеСклада = "";
						Если НЕ Стр.Склад.ЭтоГруппа Тогда
							Если Стр.Склад.ИспользоватьДляСайта И ЗначениеЗаполнено(Стр.Склад.ASP_НаименованиеДляСайта) Тогда
								НаименованиеСклада = Стр.Склад.ASP_НаименованиеДляСайта;
							Иначе 
								НаименованиеСклада = Стр.Склад;
							КонецЕсли;
						Иначе
							НаименованиеСклада = Стр.Склад;
						КонецЕсли;
						...
						СтруктураМассива.Вставить("Склад", НаименованиеСклада);
						СтруктураМассива.Вставить("Количество", КолДрСклады);
						МассивПроверка.Добавить(СтруктураМассива);
						//--ASP 000028159 Колчаев 01.10.2025 в комментарий записывается либо наименование склада для сайта, если оно заполнено и используется, либо стандартная наименование
						
					КонецЕсли; 
				Иначе
					Если Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.РезервироватьПоМереПоступления Тогда 
						КолРезервироватьПоМереПоступления = КолРезервироватьПоМереПоступления + Стр.Количество;
					ИначеЕсли Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.ПереданРанее Тогда
						КолПереданРанее = КолПереданРанее+ Стр.Количество;
					ИначеЕсли Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.Отгрузить Тогда
						
						//++ASP_Трунькин 000029473 06/02/2026 
						//КолОтгрузить = КолОтгрузить+ Стр.Количество;
						КолОтгрузить = Стр.Количество;
						НаименованиеСклада = "";
						Если НЕ Стр.Склад.ЭтоГруппа Тогда
							Если Стр.Склад.ИспользоватьДляСайта И ЗначениеЗаполнено(Стр.Склад.ASP_НаименованиеДляСайта) Тогда
								НаименованиеСклада = Стр.Склад.ASP_НаименованиеДляСайта;
						...
						СтруктураМассива = Новый Структура;
						СтруктураМассива.Вставить("Склад", НаименованиеСклада);
						СтруктураМассива.Вставить("Количество", КолОтгрузить);
						МассивКолОтгрузить.Добавить(СтруктураМассива);
						//--ASP_Трунькин 000029473 06/02/2026;
						
					ИначеЕсли Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.НеТребуется Тогда
						
						//++ASP_Трунькин 000029473 06/02/2026 
						//КолНеОбеспечивать = КолНеОбеспечивать+ Стр.Количество;
						КолНеОбеспечивать = Стр.Количество;
						НаименованиеСклада = "";
						Если НЕ Стр.Склад.ЭтоГруппа Тогда
							Если Стр.Склад.ИспользоватьДляСайта И ЗначениеЗаполнено(Стр.Склад.ASP_НаименованиеДляСайта) Тогда
								НаименованиеСклада = Стр.Склад.ASP_НаименованиеДляСайта;
						...
						СтруктураМассива = Новый Структура;
						СтруктураМассива.Вставить("Склад", НаименованиеСклада);
						СтруктураМассива.Вставить("Количество", КолНеОбеспечивать);
						МассивПроверкаКолНеОбеспечивать.Добавить(СтруктураМассива);
						//--ASP_Трунькин 000029473 06/02/2026
						
					ИначеЕсли Стр.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.КОбеспечению Тогда
						
						//++ASP_Трунькин 000029473 06/02/2026 
						//КолКОбеспечению = КолКОбеспечению+ Стр.Количество;
						КолКОбеспечению = Стр.Количество;
						НаименованиеСклада = "";
						Если НЕ Стр.Склад.ЭтоГруппа Тогда
							Если Стр.Склад.ИспользоватьДляСайта И ЗначениеЗаполнено(Стр.Склад.ASP_НаименованиеДляСайта) Тогда
								НаименованиеСклада = Стр.Склад.ASP_НаименованиеДляСайта;
						...
						СтруктураМассива = Новый Структура;
						СтруктураМассива.Вставить("Склад", НаименованиеСклада);
						СтруктураМассива.Вставить("Количество", КолКОбеспечению);
						МассивПроверкаКОбеспечению.Добавить(СтруктураМассива);
						//--ASP_Трунькин 000029473 06/02/2026
						
					КонецЕсли; 
				КонецЕсли;	
			КонецЦикла;
			КоммОснСклад = ?(ЗначениеЗаполнено(КолОснСклад), "Склад отгрузки - резерв " + КолОснСклад +" шт." + Символы.ПС, " ") ;
			
			//++ASP 000028159 Колчаев 01.10.2025 перебор массива для поулчения строки комментария с указанием всех доп складов
			МассивСтрока = "";
			Для Каждого ЭлементМассива из МассивПроверка Цикл
				МассивСтрока = МассивСтрока + " " + ЭлементМассива.Склад + " " + ЭлементМассива.Количество + " шт.";
			КонецЦикла;
			
			//++ASP_Трунькин 000029473 06/02/2026 масштабируем функционал
			МассивСтрокаКОбеспечению = "";
			Для Каждого ЭлементМассива из МассивПроверкаКОбеспечению Цикл
				МассивСтрокаКОбеспечению = МассивСтрокаКОбеспечению + " " + ЭлементМассива.Склад + " " + ЭлементМассива.Количество + " шт.";
			КонецЦикла;
			
			МассивСтрокаКолНеОбеспечивать = "";
			Для Каждого ЭлементМассива из МассивПроверкаКолНеОбеспечивать Цикл
				МассивСтрокаКолНеОбеспечивать = МассивСтрокаКолНеОбеспечивать + " " + ЭлементМассива.Склад + " " + ЭлементМассива.Количество + " шт.";
			КонецЦикла;
			
			МассивСтрокаКолОтгрузить = "";
			Для Каждого ЭлементМассива из МассивКолОтгрузить Цикл
				МассивСтрокаКолОтгрузить = МассивСтрокаКолОтгрузить + " " + ЭлементМассива.Склад + " " + ЭлементМассива.Количество + " шт.";
			КонецЦикла;			
			//--ASP_Трунькин 000029473 06/02/2026
			
			//--ASP 000028159 Колчаев 01.10.2025 перебор массива для поулчения строки комментария с указанием всех доп складов
			
			//++ASP 000028159 Колчаев 01.10.2025 добавлено указание наименования склада
			КоммДрСклады = ?(ЗначениеЗаполнено(КолДрСклады), "Резерв - " + МассивСтрока + Символы.ПС, "");//
			//--ASP 000028159 Колчаев 01.10.2025 добавлено указание наименования склада
			
			//КоммНеОбеспечивать = ?(ЗначениеЗаполнено(КолНеОбеспечивать), "Не обеспечивать - " + КолНеОбеспечивать +" шт." + Символы.ПС, "");
			//КоммКОбеспечению = ?(ЗначениеЗаполнено(КолКОбеспечению), "К обеспечению - " + КолКОбеспечению +" шт." + Символы.ПС, "");
			
			//++ASP_Трунькин 000029473 06/02/2026 масштабируем функционал
			КоммНеОбеспечивать = ?(ЗначениеЗаполнено(КолНеОбеспечивать), "Не обеспечивать - " + МассивСтрокаКолНеОбеспечивать + Символы.ПС, "");
			КоммКОбеспечению = ?(ЗначениеЗаполнено(КолКОбеспечению), "К обеспечению - " + МассивСтрокаКОбеспечению + Символы.ПС, "");
			//--ASP_Трунькин 000029473 06/02/2026 
			
			КоммРезервироватьПоМереПоступления = ?(ЗначениеЗаполнено(КолРезервироватьПоМереПоступления), "Резервировать по мере поступления - " + КолРезервироватьПоМереПоступления +" шт." + Символы.ПС, ""); 
			
			//++ASP_Трунькин 000029473 06/02/2026 масштабируем функционал
			//КоммОтгрузить = ?(ЗначениеЗаполнено(КолОтгрузить), "Отгружено - " + КолОтгрузить +" шт." + Символы.ПС, "");
			КоммОтгрузить = ?(ЗначениеЗаполнено(КолОтгрузить), "Отгружено - " + МассивСтрокаКолОтгрузить + Символы.ПС, "");
			//--ASP_Трунькин 000029473 06/02/2026 
			
			//КоммПереданРанее = ?(ЗначениеЗаполнено(КолПереданРанее), "Отгружено - " + КолПереданРанее +" шт." + Символы.ПС, "");   ///???????????????????
			Коммент = КоммОснСклад + КоммДрСклады + КоммНеОбеспечивать + КоммКОбеспечению + КоммРезервироватьПоМереПоступления + КоммОтгрузить;
			
		КонецЕсли; 
		
		
		//Если ТекНоменклатура.Отменено  Тогда  
		Если ТекНоменклатура.Отменено и не ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php" Тогда   //для ЛКД передавать отмененные позиции по просьбе Юрия.
		//--000026679
		...
		Если НЕ ТекНоменклатура.ИдентификаторНоменклатуры = "ORDER_DELIVERY" тогда
			лТипНоменклатуры = "Товар";
		//++ASP_Трунькин 000027475 11/07/25 
		ИначеЕсли  ТекНоменклатура.Номенклатура = Справочники.Номенклатура.НайтиПоКоду("0-000005135") Тогда
			лТипНоменклатуры = "Товар";
			XDTOТовар.Ид = XMLСтрока(ТекНоменклатура.Номенклатура.УникальныйИдентификатор()); 
		//--ASP_Трунькин 000027475 11/07/25
		Иначе
			лТипНоменклатуры = "Услуга";
		КонецЕсли;
		...
		////+++  ASP_Мочалина  000026488  Добавление новых реквизитов в таб часть товары при выгрузке на сайт
		//++ASP 000028159 Колчаев 01.10.2025 приравнивание количества к единице т.к. дальше идут операции деления
		ИспрКоличество = ?(ЗначениеЗаполнено(КоличествоТекНоменклатура),КоличествоТекНоменклатура,1);
		//++ASP 000028159 Колчаев 01.10.2025 приравнивание количества к единице т.к. дальше идут операции деления
		Если ПараметрыОбмена.АдресСайта = "https://lkgts.ru/bitrix/admin/1c_exchange.php" Тогда  
			ТаблКаталогов = Неопределено;
			ПараметрыОбмена.Свойство("ТаблицаКаталогов", ТаблКаталогов);
			Если ТаблКаталогов = Неопределено Тогда  
				ПараметрыОбмена.Свойство("ТаблицаКаталоговДоп", ТаблКаталогов)
			КонецЕсли;  
			КоличКомплектов = "";
			Если ЗначениеЗаполнено(ТекНоменклатура.НоменклатураНабора) Тогда 
			ВариантКомплектацииНоменклатуры =НаборыВызовСервера.ВариантКомплектацииНоменклатурыПоУмолчанию(ТекНоменклатура.НоменклатураНабора,ТекНоменклатура.ХарактеристикаНабора); 
			ПозицияКомплекта = ВариантКомплектацииНоменклатуры.тОвары.Найти(ТекНоменклатура.Номенклатура);
			КоличВКомплекте = ?(ПозицияКомплекта = НЕопределено, 1, ПозицияКомплекта.Количество);///???  
			//++ASP 000028159 Колчаев 01.10.2025 указание общего количества вместо текущего в случае выборки нескольких номенклатур
			//КоличКомплектов = Строка(ТекНоменклатура.количество/КоличВКомплекте);	
					
			КоличКомплектов = Строка(ИспрКоличество/КоличВКомплекте);	
			//--ASP 000028159 Колчаев 01.10.2025 указание общего количества вместо текущего в случае выборки нескольких номенклатур
			КонецЕсли;
			
			//СтрТаблицы = ТаблКаталогов.Найти("Основной каталог товаров", "Каталог"); 
			СтрТаблицы = ТаблКаталогов.Найти("Каталог товаров Сайт", "Каталог");  
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#CATALOG.XML_ID", "catalog-"+ СтрТаблицы.ИдентификаторКаталога);
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#PRODUCT.XML_ID", ТекНоменклатура.Номенклатура.УникальныйИдентификатор()); 
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#TYPE_NOMEN", ТекНоменклатура.ВидНоменклатуры);
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#SET", ТекНоменклатура.НоменклатураНабора.УникальныйИдентификатор());
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#SetKol", КоличКомплектов);
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#STATUS_NOMEN", ?(ТекНоменклатура.Отменено, "Отменено",Коммент)); //000027123 Добавлен статус отменен, для отмененных товаров
			//++ASP 000028159 Колчаев 01.10.2025 указание общего количества вместо текущего в случае выборки нескольких номенклатур                                                                                                                                                                                        
			//Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#PRICE_DISCOUNT", ТекНоменклатура.Сумма/ТекНоменклатура.количество);
			Б_ОбменССайтомСервер.ДобавитьЗначениеРеквизитаXDTO(ПараметрыОбмена, XDTOЗначенияРеквизитов, XDTOЗначениеРеквизитаТип, "СвойствоКорзины#PRICE_DISCOUNT", ТекНоменклатура.Сумма/ИспрКоличество);
			//--ASP 000028159 Колчаев 01.10.2025 указание общего количества вместо текущего в случае выборки нескольких номенклатур
		Иначе
		...
		//++ASP 000028159 Колчаев 01.10.2025 в случае выбора нескольких позиций в переменной "строки" здесь запись будет суммы значения "цена" и "количество" у отобранных номенклатур
		...
		XDTOТовар.Количество	= ?(КопияМассивТоваров = Неопределено,Формат(ТекНоменклатура.Количество	, ПараметрыОбмена.ФорматКоличества), Формат(КоличествоТекНоменклатура	, ПараметрыОбмена.ФорматКоличества));
		XDTOТовар.Сумма			= ?(КопияМассивТоваров = Неопределено,Формат(ТекНоменклатура.Сумма		, ПараметрыОбмена.ФорматСуммы),Формат(СуммаТекНоменклатура		, ПараметрыОбмена.ФорматСуммы));
		//--ASP 000028159 Колчаев 01.10.2025 в случае выбора нескольких позиций в переменной "строки" здесь запись будет суммы значения "цена" и "количество" у отобранных номенклатур
