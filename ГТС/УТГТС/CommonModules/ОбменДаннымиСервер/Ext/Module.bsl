...
Функция ОбработкаОбменаДаннымиДляВыгрузки(СтруктураНастроекОбмена)
	...
	Если ОбработкаОбменаДанными.Метаданные().Реквизиты.Найти("ИмяФайлаПравилОбмена") <> Неопределено Тогда
		...
		// АльтерЛОГО Троненко И.Ю. +: выгружаем в сообщение все объекты по ссылкам в зарегистрированных объектах
		//ОбработкаОбменаДанными.НеВыгружатьОбъектыПоСсылкам = Истина;
		ОбработкаОбменаДанными.НеВыгружатьОбъектыПоСсылкам = Ложь;
		//+Троненко И.Ю.ОбработкаОбменаДанными.НеВыгружатьОбъектыПоСсылкам = Истина;
		//--//ASP_Crow 11.03.2026 000029567 В расширени
