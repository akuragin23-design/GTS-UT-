...
Процедура АвтоматическоеЗакрытиеЗаказовКлиентовПоСрокам() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	СрокиРезервирования.ЗаказКлиента,
	               ...
	               |ГДЕ
	               |	СрокиРезервирования.ОкончаниеРезервирования <= &Дата
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               ...
	               |			ЗаказКлиента В
	               |				(ВЫБРАТЬ
	               |					ВтЗаказыКЗакрытию.ЗаказКлиента
	               |				ИЗ
	               |					ВтЗаказыКЗакрытию КАК ВтЗаказыКЗакрытию)) КАК РасчетыСКлиентамиОбороты
	               |ГДЕ
	...
	|			ИЛИ ЗаказКлиентаЭтапыГрафикаОплаты.ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыОплатыКлиентом.КредитПослеОтгрузки)
