	...
	Для каждого СтрокаТЧ Из СтрокиТабличнойЧасти Цикл
		...
		Для Каждого Ограничение Из Данные.Ограничения Цикл
			...
			Если Ограничение.СуммаБезСкидки <> 0 Тогда
            	...
            	//asp+				
				//ГТС округляем ручную скидку чтобы цена 1 шт со скидкой округлялась до копеек
				СуммаРучнойСкидки1 = (СуммаБезСкидки) * (Ограничение.СуммаСкидкиКРаспределению / Ограничение.СуммаБезСкидки);
				ценадоокр=(СуммаБезСкидки-СуммаРучнойСкидки1)/СтрокаТЧ.Количество;
				окрцена=Окр((СуммаБезСкидки-СуммаРучнойСкидки1)/СтрокаТЧ.Количество, 2); 				
				СтрокаТЧ.СуммаРучнойСкидки=СуммаРучнойСкидки1+((СуммаБезСкидки-СуммаРучнойСкидки1)-окрцена*СтрокаТЧ.Количество);
                 //asp-
			Иначе
