...
//ASP__A.Zhel 29.01.2019 Возвращаем список терминалов, не трогаем типовую функцию
Функция ASP_СписокОборудованияПодключенногоКТерминалу(ЭквайринговыйТерминал, ККТ) Экспорт 
	...
	|	И ЭквайринговыеТерминалы.ПодключаемоеОборудованиеККТ = &ККТ");
	...
	Пока Выборка.Следующий() Цикл	
		Если НЕ Выборка.ИспользоватьБезПодключенияОборудования Тогда
			СписокТерминалов.Добавить(Выборка.Терминал);	
		КонецЕсли;	
	КонецЦикла;
