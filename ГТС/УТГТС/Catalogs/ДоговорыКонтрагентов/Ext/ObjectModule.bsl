...
Процедура ИнициализироватьСправочник(ДанныеЗаполнения = Неопределено, ЗаполнятьВсеРеквизиты = Истина) Экспорт
	...
	Подразделение=Менеджер.Подразделение;  //ASP_Crow 11.03.2026 000029567 В расширение           
	СтатьяДвиженияДенежныхСредств=Справочники.СтатьиДвиженияДенежныхСредств.ПоступлениеОплатыОтКлиента; //ASP_Crow 11.03.2026 000029567 В расширение
