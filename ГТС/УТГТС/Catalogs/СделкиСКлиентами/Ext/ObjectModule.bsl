...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Подразделение = Ответственный.Подразделение;//ASP_Dante 09/09/19 ASP_Crow 11.03.2026 000029567 В расширение
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//ASP_Dante 07/10/19
	Реквизит = ПроверяемыеРеквизиты.Найти("ПартнерыИКонтактныеЛица.РольПартнера");
...
Процедура ЗаполнитьНаборыЗначенийДоступа(Таблица) Экспорт
	...
	КонецЕсли;
	//ASP_Crow 11.03.2026 000029567 В расширение
	СтрокаТаб2 = Таблица.Добавить();
	СтрокаТаб2.ЗначениеДоступа = Подразделение;
