...
Процедура НастроитьФорму()
	...
	ПродукцияИСМП.Добавить(Перечисления.ОсобенностиУчетаНоменклатуры.Антисептики);
	ПродукцияИСМП.Добавить(Перечисления.ОсобенностиУчетаНоменклатуры.БАДы);
	ПродукцияИСМП.Добавить(Перечисления.ОсобенностиУчетаНоменклатуры.НикотиносодержащаяПродукция);
	ПродукцияИСМП.Добавить(Перечисления.ОсобенностиУчетаНоменклатуры.Пиво);
