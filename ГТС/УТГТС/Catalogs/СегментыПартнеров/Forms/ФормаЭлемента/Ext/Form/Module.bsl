...
Процедура Сформировать(Команда)
	...
	//ASP_Dante 30/08/19
	ТекстВопроса = "При формировании текущий сегмент будет очищен" + Символы.ПС + "Продолжить?";
	ПоказатьВопрос(Новый ОписаниеОповещения("СформироватьЗавершение1", ЭтотОбъект), ТекстВопроса, РежимДиалогаВопрос.ДаНет);
	//ASP_Dante 30/08/19СформироватьФрагмент();
КонецПроцедуры
...
&НаКлиенте
Процедура СформироватьЗавершение1(РезультатВопроса, ДополнительныеПараметры) Экспорт   
