...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если (РольДоступна("ПолныеПрава") ИЛИ РольДоступна("ASP_ЗапретРезервирования")) Тогда
		Элементы.ASP_ГруппаЗапретРезервирования.Видимость = Истина;
	КонецЕсли;
	//ASP_Dante 15/10/19
	//+++ASP Колчаев 000028159 03.10.2025 изменение доступности поля в зависимости от чекбокса	
	Если Объект.ИспользоватьДляСайта Тогда
		Элементы.ASP_НаименованиеДляСайта.Доступность = Истина;
	Иначе
		Элементы.ASP_НаименованиеДляСайта.Доступность = Ложь;
	КонецЕсли;
	//---ASP Колчаев 000028159 03.10.2025 изменение доступности поля в зависимости от чекбокса 
	//--//ASP_Crow 20.03.2026 000029567 В расширение
КонецПроцедуры
...
//+++ASP Колчаев 000028159 23.09.2025 изменение доступности поля в зависимости от чекбокса
&НаКлиенте
Процедура ASP_ИспользоватьДляСайтаПриИзменении(Элемент)      
