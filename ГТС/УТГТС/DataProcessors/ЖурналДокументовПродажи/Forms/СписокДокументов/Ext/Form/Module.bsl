...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьСписокВыбораМенеджера();//ASP_Crow 18.03.2026 000029567 В расширение
...
Процедура ПриОткрытии(Отказ)
	...
	УсловноеОформлениеСписка(); //ASP_Crow 18.03.2026 000029567 В расширение
...
Процедура УсловноеОформлениеСписка()
        //ASP_Crow 18.03.2026 000029567 В расширение
		//++ASP_Crow 22.02.2024 000021639 условное оформление
		Элемент = СписокДокументыПродажи.УсловноеОформление.Элементы.Добавить();
		ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		ОтборЭлемента.ЛевоеЗначение = новый ПолеКомпоновкиДанных("ОтметкаСклада");
		ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
		ОтборЭлемента.ПравоеЗначение = Истина;
		ОтборЭлемента.Использование = Истина;
		ЭлементУО = Элемент.Оформление;
		ЭлементУО.УстановитьЗначениеПараметра(Новый ПараметрКомпоновкиДанных("ЦветФона"),  WebЦвета.БледноЗеленый);
	    //++ASP_Crow 22.02.2024 000021639
