...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоАдресВременногоХранилища(Параметры.АдресНастроекОбмена) Тогда
		...
		//++ 000026679 ASP_Мочалина  для отключения выгрузки файлов для номенклатуры
		ВыгрузкаФайловПереключатель 				= ПланыОбмена.Б_ОбменССайтом.ПолучитьЗначениеКлючаСтруктурыНастроек(НастройкиОбмена.ИнформацияОНоменклатуре, "ВыгрузкаФайловПереключатель");
...
Функция ПрименитьНаСервере()
	...
	//++000026679   ASP_Мочалина переключатель для отключения передачи файлов для номенклатуры.
	НастройкиТовара.ИнформацияОНоменклатуре.Вставить("ВыгрузкаФайловПереключатель",ВыгрузкаФайловПереключатель );
...
Функция ПолучитьМассивИспользуемыхТоваров()
	...
	ОсновныеПараметры.Вставить("ДатаФормирования"			, ТекущаяДатаСеанса());
