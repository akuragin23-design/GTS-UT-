...
&НаКлиенте
Процедура КаталогВыгрузкиНачалоВыбораЗавершение(МассивФайлов,ДополнительныеПараметры) Экспорт
    Если МассивФайлов<>Неопределено Тогда
        Объект.КаталогВыгрузки=МассивФайлов.Получить(0);
    КонецЕсли;
КонецПроцедуры
...
Процедура ФайлЗагрузкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Диалог.Показать(Новый ОписаниеОповещения("ФайлЗагрузкиНачалоВыбораЗавершение",ЭтотОбъект));
	
КонецПроцедуры

&НаКлиенте
Процедура ФайлЗагрузкиНачалоВыбораЗавершение(МассивФайлов,ДополнительныеПараметры) Экспорт
    Если МассивФайлов<>Неопределено Тогда
        Объект.ФайлЗагрузки=МассивФайлов.Получить(0);
    КонецЕсли;
КонецПроцедуры
...
Процедура КаталогЛогаНачалоВыбораЗавершение(МассивФайлов,ДополнительныеПараметры) Экспорт
    Если МассивФайлов<>Неопределено Тогда
        Объект.КаталогЛога=МассивФайлов.Получить(0);
    КонецЕсли;
КонецПроцедуры
...
Процедура УстановитьВидимостьСтраницТипаОбмена()
	...
	Элементы.ДеактивироватьТоварыВсегда.Видимость 	= (НЕ Объект.ВыгружатьТолькоИзменения И ВыгрузкаИнформацииОНоменклатуре); 	
	Элементы.ДеактивироватьТоварыВсегда.Доступность = Объект.ДеактивироватьТоварыЕслиПолнаяВыгрузка; 	 
...
Процедура БаннерНажатие(Элемент)
	ПерейтиПоНавигационнойСсылке("http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&CHAPTER_ID=1158");
КонецПроцедуры

&НаКлиенте
Процедура ДеактивироватьТоварыЕслиПолнаяВыгрузкаПриИзменении(Элемент)
...
Функция ПолучитьНастройкиКонтрагентовПоУмолчанию()
	...
	СпкПорядокИдентификацииЮ.Добавить("ИНН+КПП");
...
Функция ПолучитьНастройкиЗаказовПоУмолчанию()
	...
	Результат.Вставить("ТочкаАктуальностиВыгрузкиДокументов", НачалоМесяца(ТекущаяДатаСеанса()));	
