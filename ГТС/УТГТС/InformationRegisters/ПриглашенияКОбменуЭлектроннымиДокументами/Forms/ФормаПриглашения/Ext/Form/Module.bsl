...
Процедура ОбновитьПредставлениеКонтрагента()
	...
	Иначе
		...
		Если Не СоздаватьКонтрагентовАвтоматически
			...
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'выбрать'"),, ЦветаСтиля.ЦветГиперссылки,, "ВыбратьКонтрагента"));
			МассивСтрок.Добавить(Пробел);
			МассивСтрок.Добавить(НСтр("ru = 'его вручную или'"));
			МассивСтрок.Добавить(Пробел);
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'создать'"),, ЦветаСтиля.ЦветГиперссылки,, "СоздатьКонтрагентаИнтерактивно"));
			МассивСтрок.Добавить(Пробел);
